<%@ Page Title="" Language="C#" MasterPageFile="~/Account.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Fruitables_project.Login" %>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="index.html" class="nav-item nav-link">Home</a> <a href="shop.html" class="nav-item nav-link">Shop</a> <a href="shop-detail.html" class="nav-item nav-link">Shop Detail</a>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder2">
            ...
            <div class="container py-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">
                            We’re sorry, the page you have looked for does not exist in our website! Maybe go to our home page or try to use a search?</p>
    ...
    <%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Fruitables_project.Login" %>--%>
...
<body>
    <div style="max-width: 500px; margin: 50px auto; background: #fff; padding: 25px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <h3 style="text-align: center; margin-bottom: 20px; color: #333;">Login Form</h3>

        <p><b>User Name</b></p>
        <%--<asp:TextBox ID="lem" runat="server" type="text" placeholder="Enter Your Email" CssClass="form-control"></asp:TextBox>--%>
        <asp:TextBox ID="lemtxt" runat="server" type="text" CssClass="form-control" placeholder="Enter UserName" ></asp:TextBox>


        <p><b>Password</b></p>
        <asp:TextBox ID="lpwdtxt" runat="server" type="password" placeholder="Enter Your Password" CssClass="form-control"></asp:TextBox>
