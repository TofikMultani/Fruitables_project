<%@ Page Title="" Language="C#" MasterPageFile="~/Site4.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Fruitables_project.WebForm4" %>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                       <div class="navbar-nav mx-auto">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="Cart.aspx" class="dropdown-item active">Cart</a> 
...
<body>
    <div class="cart-container">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <center>
                <asp:DataList ID="dlCart" runat="server" RepeatLayout="Table" RepeatColumns="1" OnItemCommand="dlCart_ItemCommand">
                   
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:HiddenField ID="hfProductId" runat="server" Value='<%# Eval("ProductId") %>' />
                                <img src='<%# Eval("Pro_Image") %>' class="product-img" alt="Product Image" />
                            </td>
                            <td><%# Eval("Pro_Name") %></td>
                            ...
                            <td>
                                <asp:TextBox ID="txtQuantity" runat="server" AutoPostBack="true"
                                    Text='<%# Eval("Quantity") %>' OnTextChanged="txtQuantity_TextChanged"
                                    CssClass="quantity-box form-control text-center"></asp:TextBox>
                            </td>
                            <td>₹<%# Convert.ToInt32(Eval("Quantity")) * Convert.ToDecimal(Eval("Pro_Price")) %></td>
                            <td>
