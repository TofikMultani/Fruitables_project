<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="ShopDetails.aspx.cs" Inherits="Fruitables_project.WebForm3" %>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <%--<a href="ShopDetails.aspx" class="nav-item nav-link active">Shop Detail</a>--%>
...
<style>
    ...
    <div class="container mt-4">
        ...
        <div class="product-list">
            <asp:DataList ID="DataList1" runat="server" CssClass="product-list" RepeatDirection="Horizontal">
                <ItemTemplate>
                    <div class="product-item">
                        <!-- Product Image -->
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Pro_Image") %>' CssClass="product-image" />
                        ...
                        <div class="product-info">
                            ...
                            <!-- Add to Cart Button -->
                            <asp:LinkButton ID="LinkButton1" runat="server" type="button" class="btn btn-add-to-cart" CommandArgument='<%# Eval("Id") %>' > <i class="fa fa-shopping-bag"></i> Add to cart</asp:LinkButton>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            //        let inputField = this.closest(".quantity").querySelector(".quantity-input");
            ...
            // Add to Cart Button Click (No Postback)
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                    <img src="img/single-item.jpg" class="img-fluid rounded" alt="Image"> </a>&nbsp;</div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="fw-bold mb-3">Brocoli</h4>
                                <p class="mb-3">
                                    Category: Vegetables</p>
                                ...
                                <p class="mb-4">
                                    Susp endisse ultricies nisi vel quam suscipit. Sabertooth peacock flounder; chain pickerel hatchetfish, pencilfish snailfish</p>
