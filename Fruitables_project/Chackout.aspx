<%@ Page Title="" Language="C#" MasterPageFile="~/Site5.Master" AutoEventWireup="true" CodeBehind="Chackout.aspx.cs" Inherits="Fruitables_project.WebForm5" %>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                ...
                                <a href="Chackout.aspx" class="dropdown-item active">Chackout</a> 
...
<body>
    <div class="checkout-container">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                ...
                                <img src='<%# Eval("Pro_Image") %>' class="product-img" />
                            </td>
                            <td><%# Eval("Pro_Name") %></td>
        ...
        <div>
            <h4>Total Amount: <asp:Label ID="lblTotal" runat="server"></asp:Label></h4>
        </div>
        ...
        <asp:Button ID="btnConfirmOrder" runat="server" Text="Confirm Order" CssClass="btn-place-order" OnClick="btnConfirmOrder_Click" />
    </div>
</body>
</html>
